...
/*
    ...
    String _sort_by0  = "sort_by=";
    String _sort_by1  = "com_nom";
    String _sort_by2  = "%3A";
    String _sort_by3  = "asc";
    String _where1    = "_where=";
    String _where2    = "%3F";
    String _where3    = "_where";
    String _where4    = "%3D";
    String _where5    = "eq";
    String _where6    = "com_nom";
    String _where7    = "%2C";
    String _where8    = "Paris";


    String prepareQuery() {
      return "$urlPrefix?$_offset&$_limit&$_sort_by0$_sort_by1$_sort_by2$_sort_by3&$_where1$_where2$_where3$_where4$_where5($_where6$_where7$_where8)";
    }
*/
   ...
   var queryString2 = "https://api-geodae.sante.gouv.fr/api/dae?offset=0&limit=20&sort_by=com_nom%3Aasc&_where=%3F_where%3Deq(com_nom%2CParis)";

   final queryString = prepareQuery();

    print ("queryString1 : " + queryString);
    print ("queryString2 : " + queryString2);
