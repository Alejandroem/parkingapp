...
class _SensorsState extends State<Sensors> {
  ...
  Widget build(BuildContext context) {
    GForce = sqrt(_accelerometer.x * _accelerometer.x + _accelerometer.y * _accelerometer.y + _accelerometer.z * _accelerometer.z) / 9.8;
    (GForce >MaxGForce ) ? MaxGForce = GForce : MaxGForce = MaxGForce;
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Gravity / G-Forces'),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  Text(GForce.toStringAsFixed(0) ,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  Text(MaxGForce.toStringAsFixed(0),
                    style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 3.0),
                  ),
                ],
              ),
