...
class pannes_autres extends StatefulWidget {
  const pannes_autres({super.key, this.androidDrawer});

  final Widget? androidDrawer;

  @override
  State<pannes_autres> createState() => pannes_autresState();
}

class pannes_autresState extends State<pannes_autres> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('pannes_autres'),
