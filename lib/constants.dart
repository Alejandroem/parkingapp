...
// couleurs
var color_theme = Colors.deepPurple;
var color_background = Colors.white60;
var color_background2 = Colors.deepPurple;
var color_shadow = Colors.grey;
var color_border = Colors.deepPurple;
var color_icone = Colors.white;
var color_button = Colors.grey;
var color_texte1 = Colors.deepPurple;
...
final TextStyle_verylarge = GoogleFonts.poppins(
    color: Colors.deepPurple, fontSize: 50, fontWeight: FontWeight.bold);
...
GoogleFonts.poppins(color: Colors.deepPurple, fontSize: 12, fontWeight: FontWeight.w600);
...
GoogleFonts.poppins(color: Colors.deepPurple, fontSize: 16, fontWeight: FontWeight.w600);
...
GoogleFonts.poppins(color: Colors.deepPurple, fontSize: 10, fontWeight: FontWeight.w600);
...
final largeTextStyle = GoogleFonts.poppins(
    color: Colors.deepPurple, fontSize: 60, fontWeight: FontWeight.bold);
